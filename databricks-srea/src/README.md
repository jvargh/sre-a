...
A production-ready **Model Context Protocol (MCP)** server that exposes Databricks REST capabilities to MCP-compatible agents and tooling. It uses structured responses, resource caching, retry-aware networking, and end-to-end resilience improvements.
